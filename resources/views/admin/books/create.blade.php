                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('ten_sach') is-invalid @enderror" id="ten_sach" name="ten_sach" value="{{ old('ten_sach') }}" required>
                            @error('ten_sach')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('id_tac_gia') is-invalid @enderror" id="id_tac_gia" name="id_tac_gia">
                                        ...
                                        <option value="{{ $tacGia->id }}" {{ old('id_tac_gia') == $tacGia->id ? 'selected' : '' }}>
                                            {{ $tacGia->ten_tac_gia }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('ma_nxb') is-invalid @enderror" id="ma_nxb" name="ma_nxb">
                                        ...
                                        <option value="{{ $nxb->ma_nxb }}" {{ old('ma_nxb') == $nxb->ma_nxb ? 'selected' : '' }}>
                                            {{ $nxb->ten_nxb }}
                                        </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('ma_quoc_gia') is-invalid @enderror" id="ma_quoc_gia" name="ma_quoc_gia">
                                ...
                                <option value="{{ $quocGia->ma_quoc_gia }}" {{ old('ma_quoc_gia') == $quocGia->ma_quoc_gia ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('gia_tien') is-invalid @enderror" id="gia_tien" name="gia_tien" value="{{ old('gia_tien') }}" required>
                                    @error('gia_tien')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('so_luong') is-invalid @enderror" id="so_luong" name="so_luong" value="{{ old('so_luong') }}" required>
                                    @error('so_luong')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control @error('ngay_phat_hanh') is-invalid @enderror" id="ngay_phat_hanh" name="ngay_phat_hanh" value="{{ old('ngay_phat_hanh') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('gioi_thieu') is-invalid @enderror" id="gioi_thieu" name="gioi_thieu" rows="4">{{ old('gioi_thieu') }}</textarea>
                            @error('gioi_thieu')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
